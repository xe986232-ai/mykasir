    ...
    <AnimatePresence>
      {itemCount > 0 && (
        <motion.button
          ...
          onClick={openSheet}
          className="absolute inset-x-0 bottom-0 z-40 mx-auto flex w-full items-center justify-between rounded-t-3xl bg-primary px-5 py-4 shadow-[0_-8px_24px_rgba(20,24,20,0.2)] active:scale-[0.99] transition-transform"
        >
